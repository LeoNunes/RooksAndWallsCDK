...
export class EbEnvironment extends Construct {
    ...
    constructor(scope: Construct, id: string, props: EbEnvironmentProps) {
        ...
        if (!props.instances.autoscalingEnabled) {
            vpc = ec2.Vpc.fromLookup(this, `${props.ebApplication.applicationName}_${props.name}_VPC`, {
                isDefault: true,
            });
            ...
            if (props.application.httpsEnabled) {
                ...
                securityGroup = new ec2.SecurityGroup(this, `${props.ebApplication.applicationName}_${props.name}_SecurityGroup`, {
                    vpc: vpc,
                ...
                cdk.Tags.of(securityGroup).add('Name', `${props.ebApplication.applicationName}-${props.name}`);
            }
        }
    ...
    private getEnvironmentOptions(props: EbEnvironmentProps, vpc?: ec2.IVpc, securityGroup?: ec2.SecurityGroup) {
